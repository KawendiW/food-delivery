...
public final class ShopMothers {
    ...
    public static class ShopCreateRequestBuilder {
        @Builder.Default String name = "name";
        @Builder.Default String description = "description";
        @Builder.Default  List<ShopAddress> addresses = new ArrayList<>(List.of(
                new ShopAddress("City2", "Street2", "House2"),
                new ShopAddress("City1", "Street1", "House1")
        ));
        @Builder.Default ShopWorkingHours workingHours = new ShopWorkingHours(new ArrayList<>(List.of(
    ...
    public static class ShopUpdateRequestBuilder{
        @Builder.Default String name = "new name";
        @Builder.Default String description = "new description";
        @Builder.Default  List<ShopAddress> addresses = new ArrayList<>(List.of(
    ...
    public static class ShopEntityBuilder{
        @Builder.Default String id = "shop1";
        @Builder.Default String slug = "shop-slug";
        @Builder.Default String name = "default name";
        @Builder.Default String description = "default description";
        @Builder.Default  List<ShopAddress> addresses = new ArrayList<>(List.of(
        ...
        @Builder.Default Boolean available = false;
